...
class UniversityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.university.university', ['universities' => $universities]);
    }
    ...
    public function destroy($id)
    {
        ...
        if($university){
            try {
                ...
                return redirect()->route('university.index')->with('message', 'This university is associated with 1 or more departments, Please delete those departments before deleting this university!')->with('alert-class', 'alert-danger');
            }
        }
        return redirect()->route('university.index')->with('message', 'University removed!')->with('alert-class', 'alert-success');
    }
