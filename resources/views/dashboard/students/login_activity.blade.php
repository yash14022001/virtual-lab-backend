                    ...
                    <div class="card-body">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th>Student's Login Time</th>
                          </tr>
                        </thead>
                        <tbody>
                            <?php $index = $login_activities->perPage() * ($login_activities->currentPage() - 1) + 1; ?>
                          @foreach($login_activities as $la)
                            <tr>
                              <td>{{$index++}}</td>
                              <td><strong>{{ $la->login_time }}</strong></td>
                              <td><strong>{{ $la->students->name }}</strong></td>
                            </tr>
                          @endforeach
                        </tbody>
                      </table>
                      {{ $login_activities->links() }}
                    </div>
                </div>
              </div>
            </div>
